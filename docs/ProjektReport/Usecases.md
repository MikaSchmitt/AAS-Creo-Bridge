...
discussed with respect to how the AAS could be applied in each context. The following use cases illustrate these concept
in their practical application across the different functional areas.
