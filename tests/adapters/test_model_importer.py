...
CREOSON_DIR = Path(Path(__file__).parent.parent.parent / "creoson")


# ASM_PATH = Path(r"C:\OneDrive\Hochschule Karlsruhe\Entwicklungsprojekt - General\04_Beispieldateien\Pliers_Creo_Baugruppe\Tutorial 2 Pliers Parts\plier_mechanism.asm")
# STEP_PATH = Path(r"C:\OneDrive\Hochschule Karlsruhe\Entwicklungsprojekt - General\04_Beispieldateien\GPLE60-3S\GPLE60-3S.stp")
